...
class HHSReportedPatientImpactHospitalCapacityFacility(HHSDataset):
    ...
    def normalize(self, data: str) -> pd.DataFrame:
        ...
        crename = {
            "inpatient_beds_7_day_canavg": ScraperVariable(
                category="hospital_beds_capacity",
                measurement="rolling_average_7_day",
                unit="beds",
            ),
            "inpatient_beds_used_7_day_canavg": ScraperVariable(
            ...
            "inpatient_beds_used_covid_7_day_canavg": ScraperVariable(
                category="hospital_beds_in_use_covid",
                measurement="rolling_average_7_day",
                unit="beds",
            ),
            "total_staffed_adult_icu_beds_7_day_canavg": ScraperVariable(
                category="adult_icu_beds_capacity",
                measurement="rolling_average_7_day",
                unit="beds",
            ),
            "staffed_adult_icu_bed_occupancy_7_day_canavg": ScraperVariable(
                category="adult_icu_beds_in_use",
                measurement="rolling_average_7_day",
                unit="beds",
            ),
            "staffed_icu_adult_patients_confirmed_covid_7_day_canavg": ScraperVariable(
