...
* If the geography is a hospital region, we use our own internal convention with a 5 digit number. The first 2 digits correspond to the state fips code and the final 3 digits denote which hospital region in the specified state
